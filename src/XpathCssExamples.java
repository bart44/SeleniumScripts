...
public class XpathCssExamples {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.cssSelector("input#password")).sendKeys("siki weroniki");
		...
		*/
		...
		driver.findElement(By.xpath("//input[contains(@id,'login')]")).sendKeys("dupa"); //when attribute changes - contains(@attribute,notFullVal)
		driver.findElement(By.cssSelector("input#password")).sendKeys("siki weroniki");
